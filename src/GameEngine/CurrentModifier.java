...
/**
 * <b> CurrentModidier is a logical part of the game representing the current
 * modifier presents in the grid.</b>
 * <p>
 ...
 * <ul>
 * <li> Coordinates in x and y axes. </li>
 * </ul>
 * </p>
 *
 * @see Modifier
...
public class CurrentModifier extends Modifier {
   ...
   * <p>
   * Call displayOnBrick to verify if the coordinates is free, else try others
   * coordinates </p>
   *
   * @param gridRep An array of Brick to verify if the coordinates are free in
   * grid
   */
  ...
  /**
   * Verify if the coordinates are free Is used in constructor.
   *
